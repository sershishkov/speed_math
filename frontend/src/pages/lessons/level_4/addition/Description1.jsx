  ...
  return (
    ...
    >
      ...
      <AccordionDetails>
        ...
        <Typography variant='body1'>
          А как насчет 57? Прибавляем 60 и вычитаем З.
        </Typography>
        <Typography variant='body1'>
        ...
        <Typography variant='body1'>Теперь прибавим 78.</Typography>
        <Typography variant='body1'>
        ...
        <Typography variant='body1'>Верный ли это ответ?</Typography>
        <Typography variant='body1'>
        ...
        <Typography variant='body1'>Ответ верен.</Typography>
        <Typography variant='body1'>
