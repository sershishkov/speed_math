...
function RefNumber200() {
  const [min, set__min] = useState(190);
  const [max, set__max] = useState(220);
  ...
  return (
    <Grid container direction='column'>
      <Header
        hrefPrev='/lessons/level_3/ref-number-50'
        hrefNext='/lessons/level_3/ref-number-500'
        time={time}
        title=' Умножение чисел с опорным числом 200 (над и под опорным числом)'
      />
      <Description />
      <Settings
