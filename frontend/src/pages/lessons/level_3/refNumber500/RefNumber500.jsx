...
function RefNumber500() {
  ...
  const [max, set__max] = useState(520);
  ...
  return (
    <Grid container direction='column'>
      <Header
        hrefPrev='/lessons/level_3/ref-number-200'
        hrefNext='/lessons/level_3/decimals'
        time={time}
        title='Умножение чисел с опорным числом 500 (над и под опорным числом)'
      />
      <Description />
      <Settings
