...
function RefNumber50() {
  const [min, set__min] = useState(41);
  const [max, set__max] = useState(59);
  ...
  return (
    <Grid container direction='column'>
      <Header
        hrefPrev='/lessons/level_3/ref-number-20'
        hrefNext='/lessons/level_3/ref-number-200'
        time={time}
        title=' Умножение чисел с опорным числом 50 (над и под опорным числом)'
      />
      <Description />
      <Settings
