...
function ReferenceNumber100Mix() {
  ...
  return (
    <Grid container direction='column'>
      <Header
        hrefPrev='/lessons/level_2/ref-number-100-below'
        hrefNext='/lessons/level_2/checking-answers'
        time={time}
        title='Умножение чисел с опорным числом 100 (над и под опорным числом)'
      />
