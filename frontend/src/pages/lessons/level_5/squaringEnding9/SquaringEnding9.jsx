...
import { genExample__SquaringEnding_9 } from '../../../../utils/generateExample';
import {
  update__statistic,
...
function SquaringEnding9() {
  ...
  const nextTask = () => {
    set__example(new genExample__SquaringEnding_9(max));
  ...
  return (
    <Grid container direction='column'>
      <Header
        hrefPrev='/lessons/level_5/squaring-ending-1'
        hrefNext='/lessons/level_6/division-by-single-number'
        time={time}
        title='Возведение в квадрат чисел оканчивающихся на 9'
      />
      <Description1 />
      <Settings
...
export default SquaringEnding9;
